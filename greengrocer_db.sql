...
(2,'Salatalık','VEG',29.90,90.00,20.00,NULL,1),
(3,'Biber (Çarliston)','VEG',44.90,70.00,18.00,NULL,1),
(4,'Patlıcan','VEG',39.90,65.00,15.00,NULL,1),
(5,'Patates','VEG',19.90,200.00,40.00,NULL,1),
(6,'Soğan','VEG',14.90,180.00,35.00,NULL,1),
(7,'Havuç','VEG',22.90,110.00,22.00,NULL,1),
(8,'Marul (Kıvırcık)','VEG',24.90,55.00,12.00,NULL,1),
(9,'Ispanak','VEG',29.90,45.00,10.00,NULL,1),
(10,'Kabak','VEG',27.90,60.00,14.00,NULL,1),
(11,'Brokoli','VEG',49.90,35.00,9.00,NULL,1),
(12,'Karnabahar','VEG',46.90,38.00,10.00,NULL,1),
(13,'Sarımsak','VEG',119.90,18.00,6.00,NULL,1),
(14,'Maydanoz','VEG',9.90,25.00,8.00,NULL,1),
(15,'Limon (Adetlik)','VEG',6.50,80.00,18.00,NULL,1),
(16,'Elma (Starking)','FRUIT',34.90,140.00,30.00,NULL,1),
(17,'Muz','FRUIT',59.90,85.00,20.00,NULL,1),
(18,'Portakal','FRUIT',29.90,160.00,35.00,NULL,1),
(19,'Mandarin','FRUIT',27.90,120.00,25.00,NULL,1),
(20,'Çilek','FRUIT',99.90,25.00,8.00,NULL,1),
(21,'Üzüm (Siyah)','FRUIT',79.90,35.00,10.00,NULL,1),
(22,'Armut','FRUIT',39.90,90.00,20.00,NULL,1),
(23,'Nar','FRUIT',44.90,70.00,18.00,NULL,1),
(24,'Şeftali','FRUIT',54.90,45.00,12.00,NULL,1),
(25,'Kayısı','FRUIT',69.90,32.00,10.00,NULL,1),
(26,'Ananas','FRUIT',129.90,14.00,6.00,NULL,1),
(27,'Kivi','FRUIT',74.90,22.00,8.00,NULL,1),
(28,'Avokado','FRUIT',89.90,18.00,7.00,NULL,1),
(29,'Karpuz','FRUIT',14.90,220.00,50.00,NULL,1),
(30,'Kavun','FRUIT',24.90,160.00,40.00,NULL,1);
...
(1,1,25,'Merhaba, domates ve salatalık tazeliği hakkında bilgi alabilir miyim?','2025-12-18 10:30:00'),
(2,2,25,'Siparişim için teslimat saatini 1 saat ileri alabilir miyiz?','2025-12-18 11:40:00'),
(3,3,25,'Avokado olgun mu geliyor?','2025-12-18 12:55:00'),
(4,4,25,'Çilek stoğu ne zaman yenilenir?','2025-12-18 13:35:00'),
(5,5,25,'Kuponum neden uygulanmadı? (HOSGELDIN25)','2025-12-18 14:25:00'),
(6,6,25,'Ispanak paketleme nasıl yapılıyor?','2025-12-18 15:40:00'),
(7,7,25,'Muzlar kararmadan gelir mi?','2025-12-18 16:50:00'),
(8,8,25,'Karpuzun dilim mi bütün mü geldiğini seçebiliyor muyum?','2025-12-18 17:10:00'),
(9,9,25,'Patateslerde filizlenme olmuyor değil mi?','2025-12-17 10:30:00'),
(10,10,25,'Adres güncelledim, siparişim yeni adrese gelir mi?','2025-12-17 11:50:00'),
(11,11,25,'Portakal sulu olur mu?','2025-12-17 13:10:00'),
(12,12,25,'Brokoli taze mi, buzluğa uygun mu?','2025-12-17 13:40:00'),
(13,13,25,'Üzüm çekirdekli mi çekirdeksiz mi?','2025-12-17 14:40:00'),
(14,14,25,'Siparişe sonradan ürün ekleyebilir miyim?','2025-12-17 15:10:00'),
(15,15,25,'Kargo.melike ile teslimat yapılıyor mu?','2025-12-17 16:50:00'),
(16,16,25,'Kuponlar birleştirilebiliyor mu?','2025-12-17 17:20:00'),
(17,17,25,'Sarımsak fiyatı biraz yüksek görünüyor, doğru mu?','2025-12-17 18:15:00'),
(18,18,25,'Kivi olgun seçimi var mı?','2025-12-17 19:40:00'),
(19,1,25,'Önceki siparişimin faturası lazım.','2025-12-16 10:20:00'),
(20,2,25,'Teslim eden kurye için puanlama nereden yapılıyor?','2025-12-16 11:35:00'),
(21,3,25,'Narlar tatlı mı ekşi mi?','2025-12-16 12:40:00'),
(22,4,25,'Limon adetlik mi kg mı?','2025-12-16 13:30:00'),
(23,5,25,'Kayısılar yumuşak mı sert mi geliyor?','2025-12-16 14:25:00'),
(24,6,25,'Kavun seçimi var mı?','2025-12-16 15:15:00'),
(25,7,25,'Siparişim teslim edildi görünüyor ama ben almadım.','2025-12-16 16:55:00');

INSERT INTO ratings (id, order_id, carrier_id, customer_id, rating, comment, created_at) VALUES
(1,1,19,1,4,'Hızlı teslimat bekliyorum.','2025-12-19 12:00:00'),
(2,2,20,2,5,'Paketleme çok iyiydi.','2025-12-19 12:10:00'),
(3,3,21,3,4,'Ürünler tazeydi.','2025-12-19 12:20:00'),
(4,4,22,4,3,'Teslimat biraz gecikti.','2025-12-19 12:30:00'),
(5,5,23,5,5,'Mükemmel!','2025-12-19 12:40:00'),
(6,6,24,6,4,'Genel olarak iyi.','2025-12-19 12:50:00'),
(7,7,19,7,4,'Kurye nazikti.','2025-12-19 13:00:00'),
(8,8,20,8,5,'Çok memnun kaldım.','2025-12-19 13:10:00'),
(9,9,19,9,4,'Ürünler sağlamdı.','2025-12-18 10:30:00'),
(10,10,20,10,5,'Hızlı geldi.','2025-12-18 12:20:00'),
(11,11,21,11,4,'Güzel.','2025-12-18 13:40:00'),
(12,12,22,12,5,'Harika.','2025-12-18 14:10:00'),
(13,13,23,13,4,'İyi.','2025-12-18 15:20:00'),
(14,14,24,14,3,'Ortalama.','2025-12-18 16:10:00'),
(15,15,19,15,5,'Çok iyi.','2025-12-18 18:40:00'),
(16,16,20,16,4,'Memnunum.','2025-12-18 19:20:00'),
(17,17,21,17,5,'Süper.','2025-12-18 20:05:00'),
(18,18,22,18,4,'İyi.','2025-12-18 21:00:00'),
(19,19,23,1,5,'Teslimat zamanında.','2025-12-17 12:00:00'),
(20,20,24,2,4,'Ürünler taze.','2025-12-17 13:00:00'),
(21,21,19,3,5,'Çok memnun.','2025-12-17 14:00:00'),
(22,22,20,4,4,'İyi.','2025-12-17 15:00:00'),
(23,23,21,5,5,'Harika servis.','2025-12-17 16:00:00'),
(24,24,22,6,4,'İyi paketleme.','2025-12-17 17:00:00'),
(25,25,23,7,2,'Teslim edildi görünüyor ama sorun var.','2025-12-17 18:10:00');
...
SELECT 'users' tbl, COUNT(*) rows FROM users
