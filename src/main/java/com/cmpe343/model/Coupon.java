...
public class Coupon {
    ...
    public Coupon(int id, String code, CouponKind kind, double value, double minCart, boolean isActive, LocalDateTime expiresAt) {
        this.id = id;
        this.code = code;
        this.kind = kind;
        this.value = value;
     ...
     * Returns the value directly (for AMOUNT) or 0 (for PERCENT, which needs cart total).
