...
/**
 * Data Access Object for carrier rating operations.
 * Handles rating creation, retrieval, and duplicate prevention.
 * Ratings are 1-5 scale with optional comments.
 * 
 * @author Group07
 * @version 1.0
 */
public class RatingDao {
    ...
    public void createRating(int carrierId, int customerId, int score, String comment) {
        // Use correct column names: rating (not score) and created_at (not timestamp)
        // Note: created_at has DEFAULT CURRENT_TIMESTAMP, but we set it explicitly for
        // consistency
        String sql = """
