 ...
 * Handles coupon creation, retrieval, and validation.
...
public class CouponDao {
     ...
     * The customerId parameter is kept for API compatibility but not used in the
     * query.
     * 
    ...
    public List<Coupon> getActiveCouponsForCustomer(int customerId) {
        ...
        // If customer-specific coupons are needed, add: WHERE customer_id = ? OR
        // customer_id IS NULL
        String sql = """
